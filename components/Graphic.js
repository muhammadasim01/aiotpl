...
const Graphic = () => {
  return (
    <div className="container mt-5">
      <h6 className="banner_one__main_title text-center">Graphic Designing</h6>
      ...
      <h6 className="text-center banner_one_title">Web Desiging</h6>
      <p className="banner-one__text">
      ...
      <h6 className="text-center banner_one_title">Logo</h6>
      <p className="banner-one__text">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic quam qui
        ipsam expedita earum voluptas optio ea totam debitis quo?
      </p>
