                ...
                <div className="fact-one__inner">
                  <h3 className="fact-one__count counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 4789 : 0} />
                    </VisibilitySensor>
                  </h3>
                ...
                <div className="fact-one__inner">
                  <h3 className="fact-one__count counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 6400 : 0} />
                    </VisibilitySensor>
                  </h3>
                ...
                <div className="fact-one__inner">
                  <h3 className="fact-one__count counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 960 : 0} />
                    </VisibilitySensor>
                  </h3>
                ...
                <div className="fact-one__inner">
                  <h3 className="fact-one__count counter">
                    <VisibilitySensor
                      ...
                      delayedCall
                    >
                      <CountUp end={this.state.startCounter ? 378 : 0} />
                    </VisibilitySensor>
                  </h3>
